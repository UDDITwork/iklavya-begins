...
def _generate_professional(data: dict) -> bytes:
    ...
    elements.append(Paragraph("Generated by iKlavya AI Resume Builder  |  www.iklavya.in  |  iklvaywebsite@gmail.com", s_footer))
...
def _generate_sidebar(data: dict, profile_image_url: str | None = None) -> bytes:
    ...
    main.append(Paragraph("Generated by iKlavya AI Resume Builder  |  www.iklavya.in  |  iklvaywebsite@gmail.com", s_footer))
