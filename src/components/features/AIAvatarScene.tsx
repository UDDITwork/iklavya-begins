...
export default function AIAvatarScene({ speaking = false }: AIAvatarSceneProps) {
  ...
  return (
    <div className="w-full h-full flex items-center justify-center bg-green-50/40 rounded-xl">
        ...
        <div className="relative mx-auto mb-3" style={{ width: 88, height: 88 }}>
          {speaking && (
            <motion.div
              ...
              style={{ boxShadow: '0 0 20px rgba(22,101,52,0.15)' }}
          ...
          <svg viewBox="0 0 120 120" width="88" height="88">
            ...
            {/* Head outline */}
            <circle cx="60" cy="62" r="32" fill="none" stroke="#86EFAC" strokeWidth="2.5" />
            ...
            {speaking ? (
              ...
              <path
                ...
                fill="none" stroke="#166534" strokeWidth="2.5" strokeLinecap="round"
              />
            )}

            {/* Antenna */}
            <line x1="60" y1="30" x2="60" y2="20" stroke="#86EFAC" strokeWidth="2" />
            <motion.circle
              cx="60" cy="17" r="3" fill="#4ADE80"
              animate={speaking
