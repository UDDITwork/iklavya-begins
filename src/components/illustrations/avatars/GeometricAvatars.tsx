...
/* 5 unique geometric avatar faces using the blue palette.
...
function AvatarBase({ children, className }: { children: React.ReactNode; className?: string }) {
  return (
    <svg viewBox="0 0 64 64" className={className} fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      {/* Background circle */}
      <circle cx={32} cy={32} r={30} fill="#EFF6FF" fillOpacity={0.5} stroke="#1E40AF" strokeWidth={1} strokeOpacity={0.08} />
      {children}
    </svg>
  )
}
...
export function Avatar1({ className }: { className?: string }) {
  return (
    <AvatarBase className={className}>
      ...
      {/* Face */}
      <circle cx={32} cy={30} r={12} fill="url(#avatarSkin)" stroke="#1E40AF" strokeWidth={1} strokeOpacity={0.12} />
      {/* Eyes */}
      <circle cx={27} cy={28} r={1.5} fill="#1E40AF" fillOpacity={0.3} />
      <circle cx={37} cy={28} r={1.5} fill="#1E40AF" fillOpacity={0.3} />
      {/* Smile */}
      <path d="M 28 33 Q 32 37 36 33" stroke="#1E40AF" strokeWidth={1} strokeOpacity={0.15} strokeLinecap="round" fill="none" />
      {/* Shoulders */}
      <path d="M 18 50 Q 32 42 46 50" fill="url(#avatarSkin)" stroke="#1E40AF" strokeWidth={1} strokeOpacity={0.08} />
    </AvatarBase>
  )
}
...
export function Avatar2({ className }: { className?: string }) {
  return (
    <AvatarBase className={className}>
      ...
      <circle cx={32} cy={30} r={12} fill="url(#avatarSkin)" stroke="#1E40AF" strokeWidth={1} strokeOpacity={0.12} />
      {/* Glasses */}
      <circle cx={27} cy={28} r={4} fill="none" stroke="#1E40AF" strokeWidth={1} strokeOpacity={0.2} />
      <circle cx={37} cy={28} r={4} fill="none" stroke="#1E40AF" strokeWidth={1} strokeOpacity={0.2} />
      <line x1={31} y1={28} x2={33} y2={28} stroke="#1E40AF" strokeWidth={1} strokeOpacity={0.2} />
      {/* Eyes (inside glasses) */}
      <circle cx={27} cy={28} r={1.2} fill="#1E40AF" fillOpacity={0.3} />
      <circle cx={37} cy={28} r={1.2} fill="#1E40AF" fillOpacity={0.3} />
      {/* Smile */}
      <path d="M 28 34 Q 32 37 36 34" stroke="#1E40AF" strokeWidth={1} strokeOpacity={0.15} strokeLinecap="round" fill="none" />
      {/* Shoulders */}
      <path d="M 18 50 Q 32 42 46 50" fill="url(#avatarSkin)" stroke="#1E40AF" strokeWidth={1} strokeOpacity={0.08} />
    </AvatarBase>
  )
...
export function Avatar3({ className }: { className?: string }) {
  return (
    <AvatarBase className={className}>
      ...
      {/* Face */}
      <circle cx={32} cy={30} r={11} fill="url(#avatarSkin)" stroke="#1E40AF" strokeWidth={1} strokeOpacity={0.12} />
      {/* Eyes */}
      <circle cx={28} cy={28} r={1.5} fill="#1E40AF" fillOpacity={0.3} />
      <circle cx={36} cy={28} r={1.5} fill="#1E40AF" fillOpacity={0.3} />
      {/* Earring */}
      <circle cx={20} cy={33} r={2} fill="#60A5FA" fillOpacity={0.25} stroke="#60A5FA" strokeWidth={0.5} strokeOpacity={0.3} />
      {/* Smile */}
      <path d="M 28 33 Q 32 36 36 33" stroke="#1E40AF" strokeWidth={1} strokeOpacity={0.15} strokeLinecap="round" fill="none" />
      {/* Shoulders */}
      <path d="M 18 50 Q 32 42 46 50" fill="url(#avatarSkin)" stroke="#1E40AF" strokeWidth={1} strokeOpacity={0.08} />
    </AvatarBase>
  )
...
export function Avatar4({ className }: { className?: string }) {
  return (
    <AvatarBase className={className}>
      ...
      <circle cx={37} cy={28} r={1.5} fill="#1E40AF" fillOpacity={0.3} />
      {/* Mouth — wider grin */}
      <path d="M 27 34 Q 32 38 37 34" stroke="#1E40AF" strokeWidth={1} strokeOpacity={0.15} strokeLinecap="round" fill="none" />
      {/* Shoulders */}
      <path d="M 18 50 Q 32 42 46 50" fill="url(#avatarSkin)" stroke="#1E40AF" strokeWidth={1} strokeOpacity={0.08} />
    </AvatarBase>
  )
...
export function Avatar5({ className }: { className?: string }) {
  return (
    <AvatarBase className={className}>
      ...
      {/* Part line */}
      <line x1={28} y1={14} x2={26} y2={22} stroke="#1E3A8A" strokeWidth={0.5} strokeOpacity={0.15} />
      {/* Face */}
      <circle cx={32} cy={30} r={12} fill="url(#avatarSkin)" stroke="#1E40AF" strokeWidth={1} strokeOpacity={0.12} />
      {/* Eyes */}
      <circle cx={27} cy={28} r={1.5} fill="#1E40AF" fillOpacity={0.3} />
