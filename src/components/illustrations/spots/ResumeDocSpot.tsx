  ...
  return (
    <svg viewBox="0 0 160 140" className={className} fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <motion.rect
        ...
        fill="url(#docFill)" stroke="#166534" strokeWidth={1.5} strokeOpacity={0.15}
      ...
      <motion.path
        ...
        fill="url(#docFill)" stroke="#166534" strokeWidth={1} strokeOpacity={0.08}
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
      ...
      {[
        ...
        <motion.rect
          ...
          fill="#166534" fillOpacity={i === 0 || i === 4 ? 0.12 : 0.06}
          initial={{ width: 0 }}
      ...
      >
        ...
        <motion.line
          ...
          stroke="#4ADE80" strokeWidth={2} strokeOpacity={0.2} strokeLinecap="round"
        />
        {/* Star sparkle at tip */}
        <motion.path
          d="M 120 55 L 121.5 59 L 125 60 L 121.5 61 L 120 65 L 118.5 61 L 115 60 L 118.5 59 Z"
          fill="#4ADE80" fillOpacity={0.25}
