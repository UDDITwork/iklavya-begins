  ...
  return (
    <svg viewBox="0 0 160 140" className={className} fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <motion.path
        ...
        fill="url(#trophyFill)" stroke="#1E40AF" strokeWidth={1.5} strokeOpacity={0.15}
      ...
      <motion.path
        ...
        stroke="#1E40AF" strokeWidth={1.5} strokeOpacity={0.12} fill="none" strokeLinecap="round"
      ...
      <motion.rect
        ...
        fill="url(#trophyFill)" stroke="#1E40AF" strokeWidth={1} strokeOpacity={0.1}
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
      ...
      <motion.path
        ...
        fill="#1E40AF" fillOpacity={0.12} stroke="#1E40AF" strokeWidth={0.5} strokeOpacity={0.1}
      ...
      {[
        ...
        >
          <line x1={s.x - 3} y1={s.y} x2={s.x + 3} y2={s.y} stroke="#60A5FA" strokeWidth={1} />
          <line x1={s.x} y1={s.y - 3} x2={s.x} y2={s.y + 3} stroke="#60A5FA" strokeWidth={1} />
        </motion.g>
      ))}
    </svg>
  )
