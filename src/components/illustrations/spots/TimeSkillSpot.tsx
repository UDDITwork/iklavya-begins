  ...
  return (
    <svg viewBox="0 0 160 140" className={className} fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <motion.line
        ...
        stroke="#166534" strokeWidth={2.5} strokeOpacity={0.25} strokeLinecap="round"
        initial={{ rotate: -90 }}
        animate={{ rotate: 0 }}
      ...
      <motion.line
        ...
        stroke="#166534" strokeWidth={1.5} strokeOpacity={0.2} strokeLinecap="round"
        initial={{ rotate: -120 }}
        animate={{ rotate: 0 }}
      ...
      {/* Center dot */}
      <circle cx={75} cy={70} r={3} fill="#166534" fillOpacity={0.2} />
