  ...
  return (
    <svg viewBox="0 0 400 300" className={className} fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <motion.rect
        ...
        fill="url(#certFill)" stroke="#166534" strokeWidth={1.5} strokeOpacity={0.12}
      ...
      <motion.rect
        ...
        fill="none" stroke="#166534" strokeWidth={0.5} strokeOpacity={0.08}
        strokeDasharray="4 3"
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
      ...
      <motion.rect x={155} y={85} width={90} height={4} rx={2} fill="#166534" fillOpacity={0.08}
        initial={{ width: 0 }} animate={{ width: 90 }} transition={{ delay: 0.5, duration: 0.4 }} />
      <motion.rect x={145} y={100} width={110} height={6} rx={3} fill="#166534" fillOpacity={0.12}
        initial={{ width: 0 }} animate={{ width: 110 }} transition={{ delay: 0.6, duration: 0.4 }} />
      <motion.rect x={160} y={115} width={80} height={3} rx={1.5} fill="#166534" fillOpacity={0.06}
        initial={{ width: 0 }} animate={{ width: 80 }} transition={{ delay: 0.7, duration: 0.3 }} />
      <motion.rect x={150} y={125} width={100} height={3} rx={1.5} fill="#166534" fillOpacity={0.06}
      ...
      >
        <circle cx={200} cy={170} r={22} fill="url(#ribbonFill)" stroke="#166534" strokeWidth={1.5} strokeOpacity={0.15} />
        <circle cx={200} cy={170} r={15} fill="url(#certFill)" stroke="#166534" strokeWidth={1} strokeOpacity={0.1} />
        {/* Star inside badge */}
        <motion.path
      ...
      {[
        ...
        >
          <line x1={s.x - 4} y1={s.y} x2={s.x + 4} y2={s.y} stroke="#4ADE80" strokeWidth={1} />
          <line x1={s.x} y1={s.y - 4} x2={s.x} y2={s.y + 4} stroke="#4ADE80" strokeWidth={1} />
        </motion.g>
      ))}
    </svg>
  )
