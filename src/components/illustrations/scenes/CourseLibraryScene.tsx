  ...
  return (
    <svg viewBox="0 0 400 250" className={className} fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <motion.rect
        ...
        fill="url(#screenFill)" stroke="#1E40AF" strokeWidth={1.5} strokeOpacity={0.12}
      ...
      <motion.rect x={135} y={110} width={60} height={4} rx={2} fill="#1E40AF" fillOpacity={0.1}
        initial={{ width: 0 }} animate={{ width: 60 }} transition={{ delay: 0.5, duration: 0.3 }} />
      <motion.rect x={135} y={120} width={45} height={3} rx={1.5} fill="#1E40AF" fillOpacity={0.06}
        initial={{ width: 0 }} animate={{ width: 45 }} transition={{ delay: 0.6, duration: 0.3 }} />
      <motion.rect x={135} y={128} width={55} height={3} rx={1.5} fill="#1E40AF" fillOpacity={0.06}
      ...
      >
        <circle cx={240} cy={140} r={14} fill="url(#bubbleFill)" stroke="#1E40AF" strokeWidth={1} strokeOpacity={0.1} />
        <path d="M 236 133 L 248 140 L 236 147 Z" fill="#1E40AF" fillOpacity={0.15} />
      </motion.g>
      ...
      {bubbles.map((b, i) => (
        <motion.g key={i}>
          <motion.ellipse
            ...
            fill="url(#bubbleFill)" stroke="#1E40AF" strokeWidth={1} strokeOpacity={0.08}
      ...
      <motion.line
        ...
        stroke="#60A5FA" strokeWidth={0.5} strokeOpacity={0.06}
        strokeDasharray="3 5"
