  ...
  return (
    <svg viewBox="0 0 400 300" className={className} fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <motion.rect
        ...
        fill="url(#interviewFill)" stroke="#1E40AF" strokeWidth={1} strokeOpacity={0.1}
      ...
      <motion.g initial={{ opacity: 0, x: -15 }} animate={{ opacity: 1, x: 0 }} transition={{ delay: 0.3, duration: 0.5 }}>
        {/* Head */}
        <circle cx={130} cy={120} r={18} fill="url(#interviewFill)" stroke="#1E40AF" strokeWidth={1.5} strokeOpacity={0.15} />
        {/* Body */}
        <path d="M 108 170 Q 130 148 152 170" fill="url(#interviewFill)" stroke="#1E40AF" strokeWidth={1.5} strokeOpacity={0.1} />
        {/* User glow */}
        <motion.circle
          cx={130} cy={120} r={28}
          fill="none" stroke="#60A5FA" strokeWidth={1} strokeOpacity={0.08}
          animate={{ r: [28, 32, 28] }}
      ...
      <motion.g initial={{ opacity: 0, x: 15 }} animate={{ opacity: 1, x: 0 }} transition={{ delay: 0.4, duration: 0.5 }}>
        {/* Head */}
        <circle cx={270} cy={120} r={18} fill="url(#interviewFill)" stroke="#1E40AF" strokeWidth={1.5} strokeOpacity={0.15} />
        {/* Body */}
        <path d="M 248 170 Q 270 148 292 170" fill="url(#interviewFill)" stroke="#1E40AF" strokeWidth={1.5} strokeOpacity={0.1} />
        {/* AI signal arcs */}
        {[1, 2, 3].map((ring) => (
          <motion.path
            key={ring}
      ...
      <motion.g initial={{ opacity: 0, y: 8 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.6, duration: 0.4 }}>
        <rect x={195} y={155} width={10} height={20} rx={5} fill="url(#interviewFill)" stroke="#1E40AF" strokeWidth={1} strokeOpacity={0.12} />
        <line x1={200} y1={175} x2={200} y2={180} stroke="#1E40AF" strokeWidth={1} strokeOpacity={0.1} />
      </motion.g>

      {/* Waveform connection line */}
      <motion.path
        d="M 150 140 Q 165 130, 175 140 Q 185 150, 200 140 Q 215 130, 225 140 Q 235 150, 250 140"
        stroke="#60A5FA" strokeWidth={1.5} strokeOpacity={0.12}
        fill="none" strokeLinecap="round"
